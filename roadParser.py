...
class RoadParser:
        ...
        for s_coordinate in self.s_coordinates:
            ...
            for id in keys_negative:
                ...
                if self.geometry_nodes[geometry_index][0].tag == "paramPoly3":
                    ...
                    u_minus = self.u_lane[str(id + 1)][-1]
                    v_minus = self.v_lane[str(id + 1)][-1] - width
                ...
                if self.geometry_nodes[geometry_index][0].tag == "paramPoly3":
                    ...
                    minus_coordinates_after_rotate = rotate(minus_coordinates_before_rotate, hdg, rotation_around=[0,0])
    ...
    def plot_2D(self):
        ...
        plt.title("Creation of headlamp projection")
        time2 = time.time()
